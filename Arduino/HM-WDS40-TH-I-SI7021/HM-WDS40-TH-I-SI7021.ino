...
//#include <Si7021.h> //sparkfun does NOT work correctly!
...
//    Si7021          si7021;
  ...
  public:
    ...
    virtual void trigger (__attribute__ ((unused)) AlarmClock& clock) {
      ...
      //fhem shows temperature divided by 10!
      msg.init(msgcnt, (si7021.temperature()+OFFSETtemp)*10,si7021.humidity()+OFFSEThumi, device().battery().low());
